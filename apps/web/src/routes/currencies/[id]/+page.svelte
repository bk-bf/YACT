                ...
                <div class="coin-chart-toolbar">
                    ...
                    <div class="coin-chart-range">
                        <button class="coin-chip active" type="button"
                            >24h</button
                        >
                        <button class="coin-chip" type="button">7d</button>
                        <button class="coin-chip" type="button">1m</button>
                        <button class="coin-chip" type="button">1y</button>
                    </div>
                </div>

                <div class="coin-widget-wrap" aria-label={`${coin.name} chart`}>
